...
app.get('/',(req,res)=>{
    res.send(`
        ...
        >
            ...
            <a 
                href="https://discord.com/oauth2/authorize?client_id=1144161789832069141&response_type=code&redirect_uri=https%3A%2F%2Fcatchen541.github.io%2Flittle_cat%2F&scope=guilds+identify"
                style="outline: none;
                padding: 10px;
                border: none;
                font-size: 20px;
